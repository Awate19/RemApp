...
import { signout, isAuthenticated } from "./apiServices";
import { itemTotal } from "./cartMethods";
import Book from "../public/images/1.jpeg";
...
const Navbar = ({ history }) => {
  const signOutAlert = () => (
    <div className="alert mt-10">
      {window.confirm("Are You sure U want Logout ?")
        ? signout(() => {
            history.push("/");
          })
        : null}
  ...
  return (
    <nav className="mb-1 navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
